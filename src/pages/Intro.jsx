          ...
          <div className="flex justify-center items-center gap-4">
            <div>
              <button
                ...
                className="relative h-[50px] w-40 overflow-hidden border border-neutral-800 bg-white text-black shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-full before:w-0 before:duration-1000 after:absolute after:right-0 after:top-0 after:h-full after:w-0 after:duration-1000 hover:text-white hover:shadow-neutral-800 hover:before:w-2/4 hover:before:bg-neutral-800 hover:after:w-2/4 hover:after:bg-neutral-800"
              >
